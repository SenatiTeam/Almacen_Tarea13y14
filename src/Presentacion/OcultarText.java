 ...
 * class construction.
 */
public class OcultarText extends JLabel implements FocusListener, DocumentListener {
	/**
	 * 
	 */
	...
	public OcultarText(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public OcultarText(String text, JTextComponent component, Show show) {
